...
ggsave("Figure_OE_growth.pdf", width = 5, height = 2, dpi = 600)
#growth.plot
```
...
#### Generate dot plots of the cell area data for Hv (Figure 8D)
```{r}
...
#### Generate dot plots of the cell area data for Hm (Figure 8F)
```{r}
